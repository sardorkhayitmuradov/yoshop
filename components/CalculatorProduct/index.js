...
export const CalculatorProduct = () => {
  return (
    <div className='flex items-center justify-between max-w-[157px] w-full'>
        <Image src={MinusIcon} className='cursor-pointer py-[10px]' alt='minus icon' width={24} height={24} />
        ...
        <Image src={PlusIcon} className='cursor-pointer py-[10px]' alt='plus icon' width={24} height={24} />
    </div>
  )
}
