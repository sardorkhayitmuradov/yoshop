  ...
  return (
    <div className={`w-full flex items-center justify-between ${wrapperClassName}`}>
        ...
        <div className="max-w-[566px] w-full">
            <h4 className="mb-[40px] font-bold poppins text-[32px] leading-[140%] text-[#111827]">{title}</h4>
            <div className="poppins text-[20px] leading-[180%] text-[#111827]">{description ? description : children}</div>
        </div>
    </div>
  )
}
