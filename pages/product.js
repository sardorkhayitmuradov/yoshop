...
const Product = () => {
  ...
  return (
    <>
      <div
        className="z-10 fixed top-[-50px] w-[100%] h-[120vh] opacity-50 bg-[#D9D9D9] hidden"
        ref={modalWindowBg}
      ></div>
      <div
        className="buyProductModalInfo ease-linear  duration-[300ms] hidden fixed z-20 bg-[#363663] py-[50px] px-[40px] min-h-[300px] w-[728px] right-0 top-[130px] rounded-[10px] border-y border-x border-solid border-[#fff]"
        ref={modalWindowInfo}
      >
        <div className="modalInfoWrapp relative flex  justify-between">
          <button
            className="text-[30px] font-[200] text-[#ff2525] absolute right-[-30px] top-[-65px] py-3 px-3"
            onClick={() => {
      ...
      <section>
        <div className="container max-w-7xl mx-auto  bg-[#13131C] flex justify-between">
          <div className="leftProducts w-[550px] flex flex-col">
            <div className="mainImgProducts max-w-[100%] h-[592px] border-solid border-x border-y  border-[#5E5E5E] flex justify-center items-center ">
              <div className="mainImgProductWrapp ">
                <Image src={db[0].productMAinImg} alt="product-terminal" />
              </div>
            </div>
            ...
            <div className="productSideImgWrapp flex justify-between  my-[20px]">
              <div className="leftSideImgWrapp w-[270px] py-[70px] border-solid border-x border-y  border-[#5E5E5E] flex justify-center item-center">
                <Image src={db[0].side180Img} alt="product-img " />
              </div>
              <div className="rightSideImgWrapp w-[270px] py-[70px] border-solid  border-x border-y  border-[#5E5E5E] flex justify-center item-center">
                <Image src={db[0].sideRotete90Img} alt="product-img" />
              </div>
            </div>
            <div className="mainImgProducts max-w-[100%] h-[592px] border-solid border-x border-y  border-[#5E5E5E] flex justify-center items-center ">
              <div className="rotate100ImgProductWrapp ">
                <Image src={db[0].sideRotate100Img} alt="product-terminal" />
              </div>
            </div>
          </div>

          <div className="rightProductInfo w-[550px]">
            <h2 className="productTitle text-white text-[40px] font-[700] leading-[140%]">
              {db[0].title}
            </h2>
            <p className="productPrice mb-[54px]">{db[0].price}</p>
