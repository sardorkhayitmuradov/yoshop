                ...
                <div className="payCardInfoWrapp py-[30px] px-[40px] bg-[#272727] rounded-[10px] my-[40px]">
                  ...
                  <div className="payCardNumbInfo">
                    <div>
                      ...
                      <div className="flex items-center bg-[#4D5054] rounded-[5px] py-[12px] px-[12px]">
                        <input
                          type="text"
                          id="cardNumbInfo"
                          className="w-[310px] mr-[10px] bg-[transparent] border-none outline-none"
                        />
                        <span className="w-[87px] text-center border-l-2 text-[#131515] text-[14px] font-[400]">
                          MM/YY{" "}
                        </span>
                        <span className="w-[87px] text-center border-l-2 text-[#131515] text-[14px] font-[400]">
                          CVC{" "}
...
<div className="flex items-center">
  <InputCheckbox type={"checkbox"} idName={"saveCard"} inptClass={"accent-[#24CF5F] w-[24px] h-[24px]"} labelText={"Save my card for future purchase"} labelClass={"text-[#fff] text-[20px] font-[400] ml-[10px]"}/>
</div>

<div className="otherChechboxConfrimInfo mt-[40px]">
<p className="text-[#fff] text-[20px] font-[400]">
Please review the order details and payment details before proceeding to confirm your order 
</p>

<div className="flex items-center mt-[32px]">
  <InputCheckbox type={"checkbox"} idName={"termConditions"} inptClass={"accent-[#24CF5F] w-[15px] h-[16px] "} labelText={"I agree to the Terms & conditions, Privacy policy & Return policy"} labelClass={"text-[#fff] text-[20px] font-[400] ml-[33px]"}/>
</div>

<div className="flex items-center mt-[32px]">
  <InputCheckbox type={"checkbox"} idName={"signMe"} inptClass={"accent-[#24CF5F] w-[15px] h-[16px] "} labelText={"Sign me up to the email list"} labelClass={"text-[#fff] text-[20px] font-[400] ml-[33px]"}/>
</div>


<div className="confrimBtnWrapp flex flex-col my-[100px]">
    <div>
    <button
              className={
                "pt-[21px] pb-[21px] px-[123px] bg-[#4F46E5] rounded-[10px] font-bold leading-[140%] text-xl w-[100%]"
              }
              onClick={() => {
                modal();
              }}
            ...
            <button
              className={
                "pt-[21px] pb-[21px] px-[123px] bg-[transparent] rounded-[10px] font-bold leading-[140%] text-xl w-[100%] border-[1px] border-solid border-[#FC9D4F] text-[#FC9D4F] mt-[58px]"
              }
            >
              Back to calculator
            </button>
