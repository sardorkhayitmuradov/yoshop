      ...
      <section>
        <div className="site-container">
          ...
          <div className="flex items-center justify-between mb-[100px]">
            <EquipmentCard image={succesIcon2}>Software warranty</EquipmentCard>
            <EquipmentCard image={setupIcon2}>Software warranty</EquipmentCard>
            <EquipmentCard image={monitorIcon2}>
              Software warranty
            </EquipmentCard>
          </div>
          <h3 className="text-[32px] font-[700] text-[#fff] mb-[40px]">
